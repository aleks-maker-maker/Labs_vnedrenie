...
![Скриншот 1 - Настройки CrystalDiskMark](img/cdm-settings.png)
*Рисунок 1 – Настройки программы перед запуском теста*

![Скриншот 2 - Процесс выполнения теста](img/cdm-running.png)
*Рисунок 2 – Выполнение тестов (заполнение шкал)*

После завершения тестирования были получены следующие результаты:

![Скриншот 3 - Результаты CrystalDiskMark](img/cdm-result.png)
...
![Скриншот 4 - Главное окно CrystalDiskInfo](img/cdi-main.png)
*Рисунок 4 – Общая информация о диске*

![Скриншот 5 - Детальные атрибуты S.M.A.R.T.](img/cdi-smart.png)
