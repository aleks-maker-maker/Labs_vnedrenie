...
![Скриншот 2 - Процесс выполнения теста](CrystalDiskMark.png)
*Рисунок 2 – Выполнение тестов (заполнение шкал)*

После завершения тестирования были получены следующие результаты:

![Скриншот 3 - Результаты CrystalDiskMark](img/CrystalDiskInfo.png)
...
![Скриншот 4 - Главное окно CrystalDiskInfo](img/4.png)
*Рисунок 4 – Общая информация о диске*

![Скриншот 5 - Детальные атрибуты S.M.A.R.T.](img/5.png)
