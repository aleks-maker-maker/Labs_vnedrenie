...
![Скриншот 1 - Главное окно BurnInTest](img/burnintest-main.png)
...
![Скриншот 3 - Процесс выполнения тестов](img/burnintest-running.png)
...
![Скриншот 4 - Финальные результаты тестирования](img/burnintest-result.png)
...
### 3D Graphics
Тест 3D-графики не проводился (отсутствует дискретная видеокарта или тест не был выбран в настройках). Для офисного ПК это не является критичным.
